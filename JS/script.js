...
startBtn.addEventListener("click", () => {
    ...
    const overlay = document.getElementById('luaOverlay');
const fecharBtn = document.getElementById('fecharLua');

// Mostrar o overlay (por exemplo, quando clicar em outro botão)
function abrirLua() {
